...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___gatsbyRemarkPlugins___options___titleToURLPath'
...
export type SitePluginPluginOptionsGatsbyRemarkPluginsOptions = {
  ...
  titleToURLPath?: Maybe<Scalars['String']>;
...
export type SitePluginPluginOptionsGatsbyRemarkPluginsOptionsFilterInput = {
  ...
  titleToURLPath?: Maybe<StringQueryOperatorInput>;
...
export type MdxQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type MdxQueryQuery = { mdx?: Maybe<(
    Pick<Mdx, 'body'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'description' | 'image'>>, inboundReferences: Array<(
      Pick<Mdx, 'slug'>
